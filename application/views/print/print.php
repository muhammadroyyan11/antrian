  ...
  <link href="<?php echo base_url('assets/user')?>/lib/themes/metroui.css" rel="stylesheet">
    ...
    <div class="card" style="width: 20rem;">
      <ul class="list-group list-group-flush">
        <li class="list-group-item text-center"><h3>SELAMAT DATANG</h3><h5>Di Dinas Kependudukan Dan Pencatatan Sipil</h5>
            <h8>Jalan Kenangan Indah 4E No.16 Rt.07/Rw.98</h8>
        </li>
        <li class="list-group-item text-center">
            <?php foreach ($antrianloket as $a => $data) { ?>
            <div class="row card-link"><?= $data->tgl_antrian_loket ?></div>
            <h4>ANTRIAN</h4><h1><?php echo $data->no_antrian_loket ?></h1>
        </li>
        <?php }?>
