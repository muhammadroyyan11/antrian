<html moznomarginboxes mozdisallowselectionprint>
    ...
    <body <?php if($this->input->get('print')) echo 'onload="window.print();"'; ?>><!-- window.print(); -->
        <div class="content">
            <div class="title">
                <strong>Dinas Kependudukan Dan Pencatatan Sipil</strong><br><i class="slogan">Jl. Krisna Niwen No. 4 <br> Wagir, Kabupaten Malang</i>
            </div>
            <div class="head-desc">
                <div class="date"><?php echo $date->format('d/m/Y H:i A'); ?><br>Tes</div>
                <div class="user">Pengunjung</div>
            </div>
