...
--
-- Host: localhost:3306
-- Generation Time: Jul 04, 2023 at 09:49 PM
...
(190, 2, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-07-19'),
(191, 2, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-07-19'),
(192, 1, 1, '<span class=\"label label-danger\">Terpanggil</span>', '2022-08-17'),
(193, 1, 1, '<span class=\"label label-danger\">Terpanggil</span>', '2022-09-21'),
(194, 2, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-09-25'),
(195, 1, 1, '<span class=\"label label-danger\">Terpanggil</span>', '2022-09-25'),
(196, 5, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-09-25'),
(197, 3, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-09-25'),
(198, 4, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-09-25'),
(199, 1, 1, '<span class=\"label label-danger\">Terpanggil</span>', '2022-10-22'),
(200, 5, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-12-02'),
(201, 2, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-12-02'),
(202, 3, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2022-12-02'),
(203, 1, 1, '<span class=\"label label-success\">Sudah terlayani</span>', '2023-06-26'),
(204, 2, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2023-06-26'),
(205, 3, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2023-06-26'),
(206, 5, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2023-06-26'),
(207, 4, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2023-06-26'),
(208, 1, 2, '<span class=\"label label-danger\">Terpanggil</span>', '2023-06-26'),
(209, 2, 1, '<span class=\"label label-warning blok\">Belum terlayani</span>', '2023-07-04');
...
(1, 'admin', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Admin', 'Malang', 1, NULL),
(2, 'loket1', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Loket 1', 'Malang', 2, 1),
...
--
ALTER TABLE `antrian`
  MODIFY `id_antrian` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;

--
-- AUTO_INCREMENT for table `antrian_loket`
--
ALTER TABLE `antrian_loket`
  MODIFY `id_antrian_loket` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
